    ...
    return (
        <div className="bg-[#0D1224]">
            <motion.div
                ...
                id="experience"
                className="px-5  my-container sm:px-8 py-16 sm:py-20 bg-[#0D1224] text-white border-y-[1px] border-transparent [border-image:linear-gradient(to_right,#0D1224,#9ca3af,#0D1224)_1]"
            ...
            >
                ...
                <div className="flex my-container flex-col lg:flex-row items-center lg:items-start gap-12 lg:gap-16 mx-auto">
                    <LeftExperience />
                    <RightExperience />
                </div>
